...
const AdvancedSearch = ({ isVisible, onOpen, onClose, setSearchValue }) => {
      ...
      {isVisible && (
        <div className={styles.container} ref={ref}>
          <p className={styles.title}>
            You are able to search across all fields including title, abstract,
            authors and full text (to find out about all the fields that you can
          ...
          <p className={styles.subtitle}>
            To get you started quickly follow this links to prefill your search
            box:
          </p>
